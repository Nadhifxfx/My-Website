...
const LoadingScreen: React.FC<LoadingScreenProps> = ({ onLoadingComplete }) => {
  ...
  return (
    <div
      className="fixed inset-0 bg-gradient-to-b from-blue-600 to-blue-800 flex flex-col items-center justify-center z-50"
      ...
      <div className="w-80 max-w-sm mx-auto">
            ...
            <div className="w-full bg-blue-900 bg-opacity-50 rounded-full h-6 border-2 border-blue-400 border-opacity-30 shadow-inner overflow-hidden">
              ...
              >
                ...
                <div
                  ...
                  style={{
                    animation:
                      progress > 0 ? 'slide 2s ease-in-out infinite' : 'none'
                  }}
                ></div>
              </div>
            </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-blue-200 text-xs opacity-75">
            ...
            <br />
            Version 2025 (Under Maintenance)
            <br />
            Website Edition
          </p>
        </div>
